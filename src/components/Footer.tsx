...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    // 2026 UPDATE: CRYSTALLINE FLOOR
    // Added shadow-inner-light to create a sharp, beveled top edge resembling a glass floor.
    <footer ref={footerRef} className="relative z-10 pt-24 pb-12 bg-slate-50/95 dark:bg-[#020408]/95 backdrop-blur-xl overflow-hidden mt-auto group/footer shadow-inner-light border-t border-white/5">
         ...
         <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12 relative z-10">
             ...
             <div className="md:col-span-4 space-y-8">
                 ...
                 <div className="flex gap-3">
                     {SOCIAL_LINKS.map(link => (
                         <a key={link.id} href={link.url} target="_blank" rel="noopener noreferrer" className="group/icon relative w-10 h-10 rounded-lg bg-slate-200 dark:bg-white/5 flex items-center justify-center transition-all hover:bg-blue-600 dark:hover:bg-cyan-500 hover:text-white hover:-translate-y-1 overflow-hidden shadow-inner-light">
             ...
             <div className="md:col-span-4">
                ...
                <div className="relative group/input">
                    ...
                    <div className="relative flex flex-col sm:flex-row bg-slate-100 dark:bg-black rounded-lg overflow-hidden border border-slate-200 dark:border-white/10 group-focus-within/input:border-cyan-500/50 transition-colors shadow-inner-light">
                ...
                <div className="mt-6 flex items-center gap-3 opacity-80">
                    <div className="w-8 h-8 rounded bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-500 shadow-[0_0_10px_rgba(16,185,129,0.2)]">
         ...
         <div className="max-w-7xl mx-auto px-6 mt-16 pt-6 border-t border-slate-200 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
             <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
                 ...
                 <div className={`flex items-center gap-2 px-3 py-1 rounded-full border bg-opacity-5 border-opacity-20 shadow-inner-light ${
             ...
             <button 
                onClick={scrollToTop}
                className="group flex items-center gap-2 px-4 py-2 rounded-full bg-slate-200 dark:bg-white/5 hover:bg-slate-300 dark:hover:bg-white/10 transition-all border border-transparent hover:border-slate-400 dark:hover:border-white/20 active:scale-95 shadow-inner-light"
             >
