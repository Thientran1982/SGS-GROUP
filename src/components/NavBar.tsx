...
const NavBar: React.FC<NavBarProps> = ({ 
  ...
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div className={`fixed inset-0 z-[49] bg-[#f8fafc]/98 dark:bg-[#020408]/98 backdrop-blur-xl transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] flex flex-col ${isMobileMenuOpen ? 'opacity-100 translate-y-0 pointer-events-auto' : 'opacity-0 -translate-y-full pointer-events-none'}`}>
